...
import com.tingtingapps.securesms.preferences.AppProtectionPreferenceFragmentActions;
...
public class PassphraseChangeActivityTest extends TextSecureEspressoTestCase<ConversationListActivity> {
  ...
  private void checkState() throws Exception {
    ...
    if (TextSecurePreferences.isPasswordDisabled(getContext())) {
      onView(withId(com.tingtingapps.securesms.R.id.old_passphrase)).check(matches(not(isDisplayed())));
      onView(withId(com.tingtingapps.securesms.R.id.old_passphrase_label)).check(matches(not(isDisplayed())));
    } else {
      onView(withId(com.tingtingapps.securesms.R.id.old_passphrase)).check(matches(isDisplayed()));
      onView(withId(com.tingtingapps.securesms.R.id.old_passphrase_label)).check(matches(isDisplayed()));
    }

    onView(withId(com.tingtingapps.securesms.R.id.new_passphrase)).check(matches(isDisplayed()));
    onView(withId(com.tingtingapps.securesms.R.id.repeat_passphrase)).check(matches(isDisplayed()));
  }
