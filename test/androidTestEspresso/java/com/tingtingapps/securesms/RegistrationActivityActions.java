...
public class RegistrationActivityActions {
  ...
  public static void typeCountryCode(String countryCode) throws Exception {
    EspressoUtil.replaceTextAndCloseKeyboard(onView(withId(com.tingtingapps.securesms.R.id.country_code)), countryCode);
  }

  public static void typeLocalNumber(String localNumber) throws Exception {
    EspressoUtil.replaceTextAndCloseKeyboard(onView(withId(com.tingtingapps.securesms.R.id.number)), localNumber);
  }

  public static void clickRegister() throws Exception {
    onView(withId(com.tingtingapps.securesms.R.id.registerButton)).perform(click());
  }

  public static void clickCancel() throws Exception {
    onView(withId(com.tingtingapps.securesms.R.id.skipButton)).perform(click());
  }

  public static void clickContinue() throws Exception {
    onView(withText(com.tingtingapps.securesms.R.string.RegistrationActivity_continue)).perform(click());
  }

  public static void clickEdit() throws Exception {
    onView(withText(com.tingtingapps.securesms.R.string.RegistrationActivity_edit)).perform(click());
  }
  ...
  public static void sleepTillRegistrationConnected() {
    ...
    while (timeout < 10000L) {
      try {
        ...
        Thread.sleep(1000);
        timeout += 1000;
        onView(withId(com.tingtingapps.securesms.R.id.verification_progress)).check(matches(isDisplayed()));
        return;
