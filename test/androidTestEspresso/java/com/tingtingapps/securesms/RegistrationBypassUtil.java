...
import com.tingtingapps.securesms.service.SmsListener;
import com.tingtingapps.securesms.util.SmsUtil;
import com.tingtingapps.securesms.test.R;
...
public class RegistrationBypassUtil {
  ...
  public static String getPstnStringForDevice(Context context) {
    ...
    final String[] TEST_DEVICES = context.getResources().getStringArray(com.tingtingapps.securesms.R.array.test_devices);
    final String[] PSTN_STRINGS = context.getResources().getStringArray(com.tingtingapps.securesms.R.array.test_pstn_numbers);
          int      deviceIndex  = -1;
  ...
  public static String getVerificationCodeForPstnString(Context context, String pstnString) {
    final String[] PSTN_STRINGS = context.getResources().getStringArray(com.tingtingapps.securesms.R.array.test_pstn_numbers);
    final String[] VERIFY_CODES = context.getResources().getStringArray(com.tingtingapps.securesms.R.array.test_verification_codes);
          int      pstnIndex    = -1;
