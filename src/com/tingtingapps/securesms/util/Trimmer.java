...
public class Trimmer {
  ...
  private static class TrimmingProgressTask extends AsyncTask<Integer, Integer, Void> implements ThreadDatabase.ProgressListener {
    ...
    protected void onPreExecute() {
      ...
      progressDialog.setTitle(com.tingtingapps.securesms.R.string.trimmer__deleting);
      progressDialog.setMessage(context.getString(com.tingtingapps.securesms.R.string.trimmer__deleting_old_messages));
    ...
    protected void onPostExecute(Void result) {
      ...
      Toast.makeText(context,
                     com.tingtingapps.securesms.R.string.trimmer__old_messages_successfully_deleted,
