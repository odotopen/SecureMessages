...
public class SaveAttachmentTask extends ProgressDialogAsyncTask<SaveAttachmentTask.Attachment, Void, Integer> {
  ...
  public SaveAttachmentTask(Context context, MasterSecret masterSecret) {
    super(context, com.tingtingapps.securesms.R.string.ConversationFragment_saving_attachment, com.tingtingapps.securesms.R.string.ConversationFragment_saving_attachment_to_sd_card);
  ...
  protected void onPostExecute(Integer result) {
    ...
    switch (result) {
      case FAILURE:
        Toast.makeText(context, com.tingtingapps.securesms.R.string.ConversationFragment_error_while_saving_attachment_to_sd_card,
            Toast.LENGTH_LONG).show();
        break;
      case SUCCESS:
        Toast.makeText(context, com.tingtingapps.securesms.R.string.ConversationFragment_success_exclamation,
            Toast.LENGTH_LONG).show();
        break;
      case WRITE_ACCESS_FAILURE:
        Toast.makeText(context, com.tingtingapps.securesms.R.string.ConversationFragment_unable_to_write_to_sd_card_exclamation,
            Toast.LENGTH_LONG).show();
        break;
    }
  }
  ...
  public static void showWarningDialog(Context context, OnClickListener onAcceptListener) {
    ...
    builder.setTitle(com.tingtingapps.securesms.R.string.ConversationFragment_save_to_sd_card);
    builder.setIconAttribute(com.tingtingapps.securesms.R.attr.dialog_alert_icon);
    builder.setCancelable(true);
    builder.setMessage(com.tingtingapps.securesms.R.string.ConversationFragment_this_media_has_been_stored_in_an_encrypted_database_warning);
    builder.setPositiveButton(com.tingtingapps.securesms.R.string.yes, onAcceptListener);
    builder.setNegativeButton(com.tingtingapps.securesms.R.string.no, null);
    builder.show();
  }
}
