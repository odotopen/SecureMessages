...
public class SelectedRecipientsAdapter extends ArrayAdapter<SelectedRecipientsAdapter.RecipientWrapper> {
  ...
  public View getView(final int position, final View convertView, final ViewGroup parent) {
    ...
    if (v == null) {
      ...
      v = vi.inflate(com.tingtingapps.securesms.R.layout.selected_recipient_list_item, null);
    ...
    if (p != null) {
      ...
      TextView name = (TextView) v.findViewById(com.tingtingapps.securesms.R.id.name);
      TextView phone = (TextView) v.findViewById(com.tingtingapps.securesms.R.id.phone);
      ImageButton delete = (ImageButton) v.findViewById(com.tingtingapps.securesms.R.id.delete);
