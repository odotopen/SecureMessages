...
public class DirectoryHelper {
  ...
  private static Optional<Account> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("com.tingtingapps.securesms");
  ...
  private static Optional<Account> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(com.tingtingapps.securesms.R.string.app_name), "com.tingtingapps.securesms");
