...
public class GroupUtil {
  ...
  public static String getDescription(Context context, String encodedGroup) {
    if (encodedGroup == null) {
      return context.getString(com.tingtingapps.securesms.R.string.GroupUtil_group_updated);
    }
    ...
    try {
      ...
      if (!members.isEmpty()) {
        description.append(context.getString(com.tingtingapps.securesms.R.string.GroupUtil_joined_the_group, Util.join(members, ", ")));
      }

      if (title != null && !title.trim().isEmpty()) {
        if (description.length() > 0) description.append(" ");
        description.append(context.getString(com.tingtingapps.securesms.R.string.GroupUtil_title_is_now, title));
      }
