 ...
 */
package com.tingtingapps.securesms.recipients;
...
import com.tingtingapps.securesms.contacts.avatars.ContactColors;
import com.tingtingapps.securesms.database.CanonicalAddressDatabase;
...
import com.tingtingapps.securesms.contacts.avatars.ContactPhoto;
import com.tingtingapps.securesms.contacts.avatars.ContactPhotoFactory;
import com.tingtingapps.securesms.database.DatabaseFactory;
import com.tingtingapps.securesms.database.RecipientPreferenceDatabase.RecipientsPreferences;
...
public class RecipientProvider {
  ...
  private static final Map<String, RecipientDetails> STATIC_DETAILS = new HashMap<String, RecipientDetails>() {{
    put("262966", new RecipientDetails("Amazon", "262966", null,
                                       ContactPhotoFactory.getResourceContactPhoto(com.tingtingapps.securesms.R.drawable.ic_amazon),
