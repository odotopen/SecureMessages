...
import com.tingtingapps.securesms.database.documents.IdentityKeyMismatchList;
import com.tingtingapps.securesms.database.model.MediaMmsMessageRecord;
import com.tingtingapps.securesms.mms.TextSlide;
...
import com.tingtingapps.securesms.util.JsonUtils;
...
import com.tingtingapps.securesms.database.documents.NetworkFailureList;
import com.tingtingapps.securesms.database.model.DisplayRecord;
...
import com.tingtingapps.securesms.jobs.TrimThreadJob;
...
import com.tingtingapps.securesms.util.LRUCache;
import com.tingtingapps.securesms.util.ListenableFutureTask;
...
import static com.tingtingapps.securesms.util.Util.canonicalizeNumber;
import static com.tingtingapps.securesms.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public static class Status {
    ...
    public static String getLabelForStatus(Context context, int status) {
      switch (status) {
        case DOWNLOAD_CONNECTING:      return context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_connecting_to_mms_server);
        case DOWNLOAD_INITIALIZED:     return context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_downloading_mms);
        case DOWNLOAD_HARD_FAILURE:    return context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_mms_download_failed);
        case DOWNLOAD_APN_UNAVAILABLE: return context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_mms_pending_download);
      }

      return context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_downloading);
    }
  ...
  public class Reader {
    ...
    private DisplayRecord.Body getBody(Cursor cursor) {
      try {
        ...
        Log.w("MmsDatabase", e);
        return new DisplayRecord.Body(context.getString(com.tingtingapps.securesms.R.string.MmsDatabase_error_decrypting_message), true);
      }
    }
