...
public abstract class MessageRecord extends DisplayRecord {
  ...
  public SpannableString getDisplayBody() {
    if (isGroupUpdate() && isOutgoing()) {
      return emphasisAdded(context.getString(com.tingtingapps.securesms.R.string.MessageRecord_updated_group));
    } else if (isGroupUpdate()) {
      return emphasisAdded(GroupUtil.getDescription(context, getBody().getBody()));
    } else if (isGroupQuit() && isOutgoing()) {
      return emphasisAdded(context.getString(com.tingtingapps.securesms.R.string.MessageRecord_left_group));
    } else if (isGroupQuit()) {
      return emphasisAdded(context.getString(com.tingtingapps.securesms.R.string.ConversationItem_group_action_left, getIndividualRecipient().toShortString()));
