...
import com.tingtingapps.securesms.PlayServicesProblemActivity;
...
public class GcmRefreshJob extends ContextJob {
  ...
  private void notifyGcmFailure() {
    ...
    builder.setSmallIcon(com.tingtingapps.securesms.R.drawable.icon_notification);
    builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(),
                                                      com.tingtingapps.securesms.R.drawable.ic_action_warning_red));
    builder.setContentTitle(context.getString(com.tingtingapps.securesms.R.string.GcmRefreshJob_Permanent_TextSecure_communication_failure));
