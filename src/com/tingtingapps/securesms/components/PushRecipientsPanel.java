...
public class PushRecipientsPanel extends RelativeLayout {
  ...
  private void initialize() {
    ...
    inflater.inflate(com.tingtingapps.securesms.R.layout.push_recipients_panel, this, true);

    View imageButton = findViewById(com.tingtingapps.securesms.R.id.contacts_button);
