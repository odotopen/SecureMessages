...
public class HidingImageButton extends ImageButton {
  ...
  public void hide() {
    ...
    final Animation animation = AnimationUtils.loadAnimation(getContext(), com.tingtingapps.securesms.R.anim.slide_to_right);
  ...
  public void show() {
    ...
    animateWith(AnimationUtils.loadAnimation(getContext(), com.tingtingapps.securesms.R.anim.slide_from_right));
  }
