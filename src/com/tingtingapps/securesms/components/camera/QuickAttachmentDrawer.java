package com.tingtingapps.securesms.components.camera;
...
import com.tingtingapps.securesms.components.InputAwareLayout;

import com.tingtingapps.securesms.components.KeyboardAwareLinearLayout;
import com.tingtingapps.securesms.components.camera.QuickCamera.QuickCameraListener;
import com.tingtingapps.securesms.util.ServiceUtil;
import com.tingtingapps.securesms.util.Util;
import com.tingtingapps.securesms.util.ViewUtil;

public class QuickAttachmentDrawer extends ViewGroup implements InputAwareLayout.InputView {
  ...
  private void initializeView() {
    inflate(getContext(), com.tingtingapps.securesms.R.layout.quick_attachment_drawer, this);
    quickCamera = (QuickCamera) findViewById(com.tingtingapps.securesms.R.id.quick_camera);
    updateControlsView();
  ...
  private void updateControlsView() {
    ...
    View controls = LayoutInflater.from(getContext()).inflate(isLandscape() ? com.tingtingapps.securesms.R.layout.quick_camera_controls_land
                                                                            : com.tingtingapps.securesms.R.layout.quick_camera_controls,
                                                              this, false);
    shutterButton    = (ImageButton) controls.findViewById(com.tingtingapps.securesms.R.id.shutter_button);
    swapCameraButton = (ImageButton) controls.findViewById(com.tingtingapps.securesms.R.id.swap_camera_button);
    fullScreenButton = (ImageButton) controls.findViewById(com.tingtingapps.securesms.R.id.fullscreen_button);
  ...
  private void setDrawerState(DrawerState drawerState) {
    switch (drawerState) {
    case COLLAPSED:
      fullScreenButton.setImageResource(com.tingtingapps.securesms.R.drawable.quick_camera_fullscreen);
      break;
    case HALF_EXPANDED:
      if (isLandscape()) {
      ...
      break;
    case FULL_EXPANDED:
      fullScreenButton.setImageResource(isLandscape() ? com.tingtingapps.securesms.R.drawable.quick_camera_hide
                                                      : com.tingtingapps.securesms.R.drawable.quick_camera_exit_fullscreen);
      break;
    }
  ...
  private class CameraFlipClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
      ...
      swapCameraButton.setImageResource(quickCamera.isRearCamera() ? com.tingtingapps.securesms.R.drawable.quick_camera_front
                                                                   : com.tingtingapps.securesms.R.drawable.quick_camera_rear);
    }
  }
