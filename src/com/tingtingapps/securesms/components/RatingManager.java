...
public class RatingManager {
  ...
  private static void showRatingDialog(final Context context) {
    new MaterialDialog.Builder(context)
        .title(context.getString(com.tingtingapps.securesms.R.string.RatingManager_rate_this_app))
        .content(context.getString(com.tingtingapps.securesms.R.string.RatingManager_if_you_enjoy_using_this_app_please_take_a_moment))
        .positiveText(context.getString(com.tingtingapps.securesms.R.string.RatingManager_rate_now))
        .negativeText(context.getString(com.tingtingapps.securesms.R.string.RatingManager_no_thanks))
        .neutralText(context.getString(com.tingtingapps.securesms.R.string.RatingManager_later))
