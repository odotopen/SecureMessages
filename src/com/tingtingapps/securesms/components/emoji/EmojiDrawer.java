...
import com.tingtingapps.securesms.components.RepeatableImageKey;
import com.tingtingapps.securesms.components.RepeatableImageKey.KeyEventListener;
import com.tingtingapps.securesms.components.emoji.EmojiPageView.EmojiSelectionListener;
...
public class EmojiDrawer extends LinearLayout implements InputAwareLayout.InputView {
  ...
  private void initView() {
    final View v = LayoutInflater.from(getContext()).inflate(com.tingtingapps.securesms.R.layout.emoji_drawer, this, true);
  ...
  private void initializeResources(View v) {
    ...
    this.pager     = (ViewPager)            v.findViewById(com.tingtingapps.securesms.R.id.emoji_pager);
    this.strip     = (PagerSlidingTabStrip) v.findViewById(com.tingtingapps.securesms.R.id.tabs);

    RepeatableImageKey backspace = (RepeatableImageKey)v.findViewById(com.tingtingapps.securesms.R.id.backspace);
