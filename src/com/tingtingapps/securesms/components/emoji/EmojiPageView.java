...
public class EmojiPageView extends FrameLayout {
  ...
  public EmojiPageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    final View view = LayoutInflater.from(getContext()).inflate(com.tingtingapps.securesms.R.layout.emoji_grid_layout, this, true);
    grid = (GridView) view.findViewById(com.tingtingapps.securesms.R.id.emoji);
    grid.setColumnWidth(getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.emoji_drawer_size) + 2 * getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.emoji_drawer_item_padding));
  ...
  private static class EmojiGridAdapter extends BaseAdapter {
    ...
    public EmojiGridAdapter(Context context, EmojiPageModel model) {
      ...
      this.emojiSize = (int) context.getResources().getDimension(com.tingtingapps.securesms.R.dimen.emoji_drawer_size);
      this.model     = model;
    }
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
      ...
      final int pad = context.getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.emoji_drawer_item_padding);
