...
import com.tingtingapps.securesms.components.emoji.EmojiDrawer.EmojiDrawerListener;
...
public class EmojiToggle extends ImageButton implements EmojiDrawerListener {
  ...
  private void initialize() {
    int attributes[] = new int[] {com.tingtingapps.securesms.R.attr.conversation_emoji_toggle,
        com.tingtingapps.securesms.R.attr.conversation_keyboard_toggle};
