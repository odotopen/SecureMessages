...
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
  ...
  public KeyboardAwareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    minKeyboardSize            = getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.min_keyboard_size);
    minCustomKeyboardSize      = getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.min_custom_keyboard_size);
    defaultCustomKeyboardSize  = getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.default_custom_keyboard_size);
    minCustomKeyboardTopMargin = getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.min_custom_keyboard_top_margin);
