...
public class ReminderView extends LinearLayout {
  ...
  private void initialize() {
    LayoutInflater.from(getContext()).inflate(com.tingtingapps.securesms.R.layout.reminder_header, this, true);
    container = (ViewGroup  ) findViewById(com.tingtingapps.securesms.R.id.container);
    cancel    = (ImageButton) findViewById(com.tingtingapps.securesms.R.id.cancel);
    title     = (TextView   ) findViewById(com.tingtingapps.securesms.R.id.reminder_title);
    text      = (TextView   ) findViewById(com.tingtingapps.securesms.R.id.reminder_text);
    icon      = (ImageView  ) findViewById(com.tingtingapps.securesms.R.id.icon);
  }
