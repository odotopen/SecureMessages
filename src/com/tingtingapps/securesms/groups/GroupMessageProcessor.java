package com.tingtingapps.securesms.groups;
...
import com.tingtingapps.securesms.jobs.AvatarDownloadJob;
...
public class GroupMessageProcessor {
                             ...
                             @NonNull TextSecureDataMessage message)
  {
    ...
    GroupDatabase.GroupRecord record   = database.getGroup(id);
