...
import com.tingtingapps.securesms.recipients.RecipientsFormatter;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    public RecipientsAdapter(Context context) {
        super(context, com.tingtingapps.securesms.R.layout.recipient_filter_item, null);
        mContext = context;
    ...
    public final void bindView(View view, Context context, Cursor cursor) {
        TextView name = (TextView) view.findViewById(com.tingtingapps.securesms.R.id.name);
        name.setText(cursor.getString(NAME_INDEX));

        TextView label = (TextView) view.findViewById(com.tingtingapps.securesms.R.id.label);
        int type = cursor.getInt(TYPE_INDEX);
        label.setText(mContactAccessor.phoneTypeToString(mContext, type, cursor.getString(LABEL_INDEX)));

        TextView number = (TextView) view.findViewById(com.tingtingapps.securesms.R.id.number);
