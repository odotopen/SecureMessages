...
public class ContactSelectionListItem extends RelativeLayout implements Recipients.RecipientsModifiedListener {
  ...
  protected void onFinishInflate() {
    ...
    this.contactPhotoImage = (AvatarImageView) findViewById(com.tingtingapps.securesms.R.id.contact_photo_image);
    this.numberView        = (TextView)        findViewById(com.tingtingapps.securesms.R.id.number);
    this.labelView         = (TextView)        findViewById(com.tingtingapps.securesms.R.id.label);
    this.nameView          = (TextView)        findViewById(com.tingtingapps.securesms.R.id.name);
    this.checkBox          = (CheckBox)        findViewById(com.tingtingapps.securesms.R.id.check_box);
  }
