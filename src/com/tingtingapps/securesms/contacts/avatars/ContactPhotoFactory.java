...
public class ContactPhotoFactory {
  ...
  public static ContactPhoto getDefaultGroupPhoto() {
    return new ResourceContactPhoto(com.tingtingapps.securesms.R.drawable.ic_group_white_24dp);
  }
  ...
  public static ContactPhoto getContactPhoto(Context context, Uri uri, String name) {
    try {
      ...
      int         targetSize  = context.getResources().getDimensionPixelSize(com.tingtingapps.securesms.R.dimen.contact_photo_target_size);
