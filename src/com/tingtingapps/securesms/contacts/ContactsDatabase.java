 ...
 */
package com.tingtingapps.securesms.contacts;
...
public class ContactsDatabase {
                                       ...
                                       Account account, String e164number, long aggregateId)
  {
    ...
    operations.add(ContentProviderOperation.newInsert(dataUri)
                                           ...
                                           .withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.tingtingapps.securesms.contact")
                                           .withValue(ContactsContract.Data.DATA1, e164number)
                                           .withValue(ContactsContract.Data.DATA2, context.getString(com.tingtingapps.securesms.R.string.app_name))
                                           .withValue(ContactsContract.Data.DATA3, context.getString(com.tingtingapps.securesms.R.string.ContactsDatabase_message_s, e164number))
  ...
  public @NonNull Cursor queryTextSecureContacts(String filter) {
    ...
    if (TextUtils.isEmpty(filter)) {
      cursor = context.getContentResolver().query(ContactsContract.Data.CONTENT_URI,
                                                  ...
                                                  new String[] {"vnd.android.cursor.item/vnd.com.tingtingapps.securesms.contact"},
                                                  sort);
    } else {
      cursor = context.getContentResolver().query(ContactsContract.Data.CONTENT_URI,
                                                  projection,
  ...
  public Cursor getNewNumberCursor(String filter) {
    ...
    newNumberCursor.addRow(new Object[]{-1L, context.getString(com.tingtingapps.securesms.R.string.contact_selection_list__unknown_contact),
