...
import com.tingtingapps.securesms.push.TextSecureCommunicationFactory;
...
public class RegistrationService extends Service {
  ...
  public static final String REGISTER_NUMBER_ACTION = "com.tingtingapps.securesms.RegistrationService.REGISTER_NUMBER";
  public static final String VOICE_REQUESTED_ACTION = "com.tingtingapps.securesms.RegistrationService.VOICE_REQUESTED";
  public static final String VOICE_REGISTER_ACTION  = "com.tingtingapps.securesms.RegistrationService.VOICE_REGISTER";

  public static final String NOTIFICATION_TITLE     = "com.tingtingapps.securesms.NOTIFICATION_TITLE";
  public static final String NOTIFICATION_TEXT      = "com.tingtingapps.securesms.NOTIFICATION_TEXT";
  public static final String CHALLENGE_EVENT        = "com.tingtingapps.securesms.CHALLENGE_EVENT";
  public static final String REGISTRATION_EVENT     = "com.tingtingapps.securesms.REGISTRATION_EVENT";
  ...
  private void broadcastComplete(boolean success) {
    ...
    if (success) {
      intent.putExtra(NOTIFICATION_TITLE, getString(com.tingtingapps.securesms.R.string.RegistrationService_registration_complete));
      intent.putExtra(NOTIFICATION_TEXT, getString(com.tingtingapps.securesms.R.string.RegistrationService_textsecure_registration_has_successfully_completed));
    } else {
      intent.putExtra(NOTIFICATION_TITLE, getString(com.tingtingapps.securesms.R.string.RegistrationService_registration_error));
      intent.putExtra(NOTIFICATION_TEXT, getString(com.tingtingapps.securesms.R.string.RegistrationService_textsecure_registration_has_encountered_a_problem));
    }
