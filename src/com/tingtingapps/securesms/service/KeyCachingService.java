...
import com.tingtingapps.securesms.DatabaseUpgradeActivity;
import com.tingtingapps.securesms.DummyActivity;
import com.tingtingapps.securesms.crypto.MasterSecret;
import com.tingtingapps.securesms.crypto.MasterSecretUtil;
import com.tingtingapps.securesms.jobs.MasterSecretDecryptJob;
...
import com.tingtingapps.securesms.crypto.InvalidPassphraseException;
...
public class KeyCachingService extends Service {
  ...
  public  static final String KEY_PERMISSION           = "com.tingtingapps.securesms.ACCESS_SECRETS";
  public  static final String NEW_KEY_EVENT            = "com.tingtingapps.securesms.service.action.NEW_KEY_EVENT";
  public  static final String CLEAR_KEY_EVENT          = "com.tingtingapps.securesms.service.action.CLEAR_KEY_EVENT";
  private static final String PASSPHRASE_EXPIRED_EVENT = "com.tingtingapps.securesms.service.action.PASSPHRASE_EXPIRED_EVENT";
  public  static final String CLEAR_KEY_ACTION         = "com.tingtingapps.securesms.service.action.CLEAR_KEY";
  public  static final String DISABLE_ACTION           = "com.tingtingapps.securesms.service.action.DISABLE";
  public  static final String ACTIVITY_START_EVENT     = "com.tingtingapps.securesms.service.action.ACTIVITY_START_EVENT";
  public  static final String ACTIVITY_STOP_EVENT      = "com.tingtingapps.securesms.service.action.ACTIVITY_STOP_EVENT";
  public  static final String LOCALE_CHANGE_EVENT      = "com.tingtingapps.securesms.service.action.LOCALE_CHANGE_EVENT";
  ...
  private void foregroundServiceModern() {
    ...
    builder.setContentText(getString(com.tingtingapps.securesms.R.string.KeyCachingService_textsecure_passphrase_cached));
    builder.setSmallIcon(com.tingtingapps.securesms.R.drawable.icon_cached);
    builder.setWhen(0);
    builder.setPriority(Notification.PRIORITY_MIN);

    builder.addAction(com.tingtingapps.securesms.R.drawable.ic_menu_lock_holo_dark, getString(com.tingtingapps.securesms.R.string.KeyCachingService_lock), buildLockIntent());
  ...
  private void foregroundServiceICS() {
    NotificationCompat.Builder builder = new NotificationCompat.Builder(this);
    RemoteViews remoteViews            = new RemoteViews(getPackageName(), com.tingtingapps.securesms.R.layout.key_caching_notification);

    remoteViews.setOnClickPendingIntent(com.tingtingapps.securesms.R.id.lock_cache_icon, buildLockIntent());
  ...
  private void foregroundServiceLegacy() {
    Notification notification  = new Notification(com.tingtingapps.securesms.R.drawable.icon_cached,
                                                  getString(com.tingtingapps.securesms.R.string.KeyCachingService_textsecure_passphrase_cached),
                                                  System.currentTimeMillis());
    notification.setLatestEventInfo(getApplicationContext(),
                                    getString(com.tingtingapps.securesms.R.string.KeyCachingService_passphrase_cached),
                                    getString(com.tingtingapps.securesms.R.string.KeyCachingService_textsecure_passphrase_cached),
                                    buildLaunchIntent());
