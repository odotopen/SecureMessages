...
import com.tingtingapps.securesms.database.SmsMigrator;
import com.tingtingapps.securesms.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.tingtingapps.securesms.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.tingtingapps.securesms.ApplicationMigrationService.COMPLETED";
