...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.tingtingapps.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("com.tingtingapps.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }
