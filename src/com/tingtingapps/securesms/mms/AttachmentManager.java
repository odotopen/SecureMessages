...
public class AttachmentManager {
  ...
  public AttachmentManager(Activity view, AttachmentListener listener) {
    this.attachmentView     = view.findViewById(com.tingtingapps.securesms.R.id.attachment_editor);
    this.thumbnail          = (ThumbnailView)view.findViewById(com.tingtingapps.securesms.R.id.attachment_thumbnail);
    this.removeButton       = (ImageView)view.findViewById(com.tingtingapps.securesms.R.id.remove_image_button);
  ...
  private static void selectMediaType(Activity activity, String type, int requestCode) {
    ...
    try {
      ...
      Toast.makeText(activity, com.tingtingapps.securesms.R.string.AttachmentManager_cant_open_media_selection, Toast.LENGTH_LONG).show();
    }
  }
