...
public class ColorPreference extends Preference {
  ...
  private int mItemLayoutId = com.tingtingapps.securesms.R.layout.color_preference_item;
  ...
  private void initAttrs(AttributeSet attrs, int defStyle) {
    TypedArray a = getContext().getTheme().obtainStyledAttributes(
        attrs, com.tingtingapps.securesms.R.styleable.ColorPreference, defStyle, defStyle);

    try {
      mItemLayoutId = a.getResourceId(com.tingtingapps.securesms.R.styleable.ColorPreference_itemLayout, mItemLayoutId);
      mNumColumns = a.getInteger(com.tingtingapps.securesms.R.styleable.ColorPreference_numColumns, mNumColumns);
...
//      }
  ...
  protected void onBindView(View view) {
    ...
    mPreviewView = view.findViewById(com.tingtingapps.securesms.R.id.color_view);
  ...
  public static class ColorDialogFragment extends android.support.v4.app.DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      View rootView = layoutInflater.inflate(com.tingtingapps.securesms.R.layout.color_preference_items, null);

      mColorGrid = (GridLayout) rootView.findViewById(com.tingtingapps.securesms.R.id.color_grid);
    ...
    private void repopulateItems() {
      ...
      for (final int color : mPreference.mColorChoices) {
        View itemView = LayoutInflater.from(context)
                                      .inflate(com.tingtingapps.securesms.R.layout.color_preference_item, mColorGrid, false);

        setColorViewValue(itemView.findViewById(com.tingtingapps.securesms.R.id.color_view), color,
...
//          TypedValue.COMPLEX_UNIT_DIP, 2, res.getDisplayMetrics()), darkenedColor);
      ...
      if (selected) {
        BitmapDrawable checkmark = (BitmapDrawable) res.getDrawable(com.tingtingapps.securesms.R.drawable.check);
