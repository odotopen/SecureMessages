...
import com.tingtingapps.securesms.util.ProgressDialogAsyncTask;
...
public class AdvancedPreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    addPreferencesFromResource(com.tingtingapps.securesms.R.xml.preferences_advanced);
  ...
  public void onResume() {
    super.onResume();
    ((ApplicationPreferencesActivity) getActivity()).getSupportActionBar().setTitle(com.tingtingapps.securesms.R.string.preferences__advanced);
  }
  ...
  private void initializeIdentitySelection() {
    ...
    if (identity.isSelfIdentityAutoDetected()) {
      ...
      if (contactUri != null) {
        ...
        preference.setSummary(String.format(getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_currently_s),
                                            contactName));
      }
  ...
  private @NonNull String getVersion(@Nullable Context context) {
    try {
      ...
      String app     = context.getString(com.tingtingapps.securesms.R.string.app_name);
      String version = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionName;

      return String.format("%s %s", app, version);
    } catch (PackageManager.NameNotFoundException e) {
      Log.w(TAG, e);
      return context.getString(com.tingtingapps.securesms.R.string.app_name);
    }
  }
  ...
  private class PushMessagingClickListener implements Preference.OnPreferenceChangeListener {
    ...
    private class DisablePushMessagesTask extends ProgressDialogAsyncTask<Void, Void, Integer> {
      ...
      public DisablePushMessagesTask(final CheckBoxPreference checkBoxPreference) {
        super(getActivity(), com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_unregistering, com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_unregistering_from_textsecure_messages);
      ...
      protected void onPostExecute(Integer result) {
        ...
        case NETWORK_ERROR:
          Toast.makeText(getActivity(),
                         com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_error_connecting_to_server,
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setIconAttribute(com.tingtingapps.securesms.R.attr.dialog_info_icon);
        builder.setTitle(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_disable_textsecure_messages);
        builder.setMessage(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_this_will_disable_textsecure_messages);
