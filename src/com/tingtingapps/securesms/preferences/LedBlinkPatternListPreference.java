...
public class LedBlinkPatternListPreference extends ListPreference implements OnSeekBarChangeListener {
  ...
  private void initializeDialog(View view) {
    ...
    builder.setTitle(com.tingtingapps.securesms.R.string.preferences__pref_led_blink_custom_pattern_title);
  ...
  private void showDialog() {
    ...
    View view               = inflater.inflate(com.tingtingapps.securesms.R.layout.led_pattern_dialog, null);

    this.seekBarOn       = (SeekBar)view.findViewById(com.tingtingapps.securesms.R.id.SeekBarOn);
    this.seekBarOff      = (SeekBar)view.findViewById(com.tingtingapps.securesms.R.id.SeekBarOff);
    this.seekBarOnLabel  = (TextView)view.findViewById(com.tingtingapps.securesms.R.id.SeekBarOnMsLabel);
    this.seekBarOffLabel = (TextView)view.findViewById(com.tingtingapps.securesms.R.id.SeekBarOffMsLabel);
  ...
  private class CustomDialogClickListener implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialog, int which) {
      ...
      Toast.makeText(context, com.tingtingapps.securesms.R.string.preferences__pref_led_blink_custom_pattern_set, Toast.LENGTH_LONG).show();
    }
