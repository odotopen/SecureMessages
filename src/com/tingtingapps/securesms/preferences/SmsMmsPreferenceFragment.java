...
public class SmsMmsPreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    addPreferencesFromResource(com.tingtingapps.securesms.R.xml.preferences_sms_mms);
  ...
  public void onResume() {
    super.onResume();
    ((ApplicationPreferencesActivity) getActivity()).getSupportActionBar().setTitle(com.tingtingapps.securesms.R.string.preferences__sms_mms);
  ...
  private void initializePlatformSpecificOptions() {
    ...
    if (VERSION.SDK_INT >= VERSION_CODES.KITKAT) {
      ...
      if (Util.isDefaultSmsProvider(getActivity())) {
        ...
        defaultPreference.setTitle(getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_sms_enabled));
        defaultPreference.setSummary(getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_touch_to_change_your_default_sms_app));
      } else {
        Intent intent = new Intent(Telephony.Sms.Intents.ACTION_CHANGE_DEFAULT);
        intent.putExtra(Telephony.Sms.Intents.EXTRA_PACKAGE_NAME, getActivity().getPackageName());
        defaultPreference.setIntent(intent);
        defaultPreference.setTitle(getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_sms_disabled));
        defaultPreference.setSummary(getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_touch_to_make_textsecure_your_default_sms_app));
      }
  ...
  public static CharSequence getSummary(Context context) {
    final String on                 = context.getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_on);
    final String onCaps             = context.getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_On);
    final String off                = context.getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_off);
    final String offCaps            = context.getString(com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_Off);
    final int    smsMmsSummaryResId = com.tingtingapps.securesms.R.string.ApplicationPreferencesActivity_sms_mms_summary;
