...
import com.tingtingapps.securesms.util.SpanUtil;
...
public class MessageNotifier {
                                                  ...
                                                  @NonNull Cursor cursor)
  {
    ...
    try {
      ...
      while ((envelope = reader.getNext()) != null) {
        ...
        SpannableString body       = new SpannableString(context.getString(com.tingtingapps.securesms.R.string.MessageNotifier_locked_message));
                                                              ...
                                                              @NonNull  Cursor cursor)
  {
    ...
    while ((record = reader.getNext()) != null) {
      ...
      if (SmsDatabase.Types.isDecryptInProgressType(record.getType()) || !record.getBody().isPlaintext()) {
        body = SpanUtil.italic(context.getString(com.tingtingapps.securesms.R.string.MessageNotifier_locked_message));
      } else if (record.isMms() && TextUtils.isEmpty(body)) {
        body = SpanUtil.italic(context.getString(com.tingtingapps.securesms.R.string.MessageNotifier_media_message));
        slideDeck = ((MediaMmsMessageRecord)record).getSlideDeckFuture();
      } else if (record.isMms() && !record.isMmsNotification()) {
        String message      = context.getString(com.tingtingapps.securesms.R.string.MessageNotifier_media_message_with_text, body);
  ...
  public static class ReminderReceiver extends BroadcastReceiver {
    ...
    public static final String REMINDER_ACTION = "com.tingtingapps.securesms.MessageNotifier.REMINDER_ACTION";
  ...
  public static class DeleteReceiver extends BroadcastReceiver {
    ...
    public static final String DELETE_REMINDER_ACTION = "com.tingtingapps.securesms.MessageNotifier.DELETE_REMINDER_ACTION";
